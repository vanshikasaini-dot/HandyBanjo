  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 py-10">
      ...
      <div className="relative z-20 w-full max-w-[420px] rounded-[30px] border border-white/20 bg-white/10 backdrop-blur-xl shadow-2xl p-6 sm:p-8">
        ...
        <h2 className="text-center text-white font-bold text-3xl">Welcome Back</h2>
        <p className="text-center text-gray-200 mt-2 mb-6">Login to continue</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center rounded-xl overflow-hidden bg-white/20 border border-white/20">
              <span className="px-4 text-white"><Mail size={18} /></span>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center rounded-xl overflow-hidden bg-white/20 border border-white/20">
              <span className="px-4 text-white"><Lock size={18} /></span>
          ...
          <button className="w-full h-[52px] rounded-[14px] font-bold text-white bg-red-500 hover:bg-red-600 transition">
            Login
          </button>
        ...
        <p className="text-center text-white mt-5">
          ...
          <Link to="/signup" className="text-red-400 ml-2">Signup</Link>
        </p>

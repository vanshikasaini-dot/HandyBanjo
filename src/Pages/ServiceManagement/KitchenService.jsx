...
export default function KitchenServiceManagement() {
  const initialServices = [
...

    {
      ...
      service: "Kitchen Chimney Repair",
      address: "Noida",
      worker: "Rohit Singh",
      status: "Completed",
      price: "₹1800",
  ...
  const handleDelete = (id) => {
    const confirmDelete = window.confirm(
      "Are you sure you want to delete this kitchen service?",
    );
      ...
      >
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm md:text-base">
            Manage all kitchen related service requests here.
          </p>
        </div>

        <button className="bg-orange-500 hover:bg-orange-600 transition-all text-white px-5 py-3 rounded-2xl font-semibold shadow-md">
          + Add Kitchen Service
        </button>
      </motion.div>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="bg-yellow-100 p-3 rounded-2xl">
              <CookingPot className="text-yellow-600" />
            </div>
          </div>
        </motion.div>
